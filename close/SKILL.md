...
- The **brain vault MCP must be connected**, and this skill flushes into THAT loaded
  connector. In Claude Code and claude.ai it is the **"SecondBrain"** connector, whose tools
